  ...
  describe('getSectorStats', () => {
    ...
    test('should calculate correct statistics for sector with data', () => {
      const sector: Sector = {
        ...
        planets: [
          { starId: 1, orbitalNumber: 1, planetType: 'R', diameter: 5000, moonCount: 2, temperature: 288 },
          { starId: 1, orbitalNumber: 2, planetType: 'G', diameter: 8000, moonCount: 1, temperature: 288 },
          { starId: 2, orbitalNumber: 1, planetType: 'R', diameter: 6000, moonCount: 0, temperature: 288 }
        ]
      };
    ...
    test('should round averages to two decimal places', () => {
      const sector: Sector = {
        ...
        planets: [
          { starId: 1, orbitalNumber: 1, planetType: 'R', diameter: 5000, moonCount: 0, temperature: 288 },
          { starId: 2, orbitalNumber: 1, planetType: 'G', diameter: 8000, moonCount: 0, temperature: 288 },
          { starId: 2, orbitalNumber: 2, planetType: 'R', diameter: 6000, moonCount: 0, temperature: 288 }
        ]
      };
